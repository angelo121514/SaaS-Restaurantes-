...
const TRANSLATIONS = {
  es: {
    ...
    securePayment: "⚡ Pedido directo a cocina",
    ...
    addons: "Agregados",
    total: "Total",
    proceedToCheckout: "Proceder a enviar a cocina",
  ...
  en: {
    ...
    fastPrep: "⚡ Fast Prep",
    securePayment: "⚡ Direct kitchen order",
    ...
    addons: "Addons",
    total: "Total",
    proceedToCheckout: "Proceed to send to kitchen",
