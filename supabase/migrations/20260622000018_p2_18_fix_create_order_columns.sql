-- =====================================================
-- Fase 2 · P1-1 Fix
-- Corregir errores de columnas inexistentes en la inserción de orders:
--   - Eliminar 'customer_email' (no existe en la tabla orders).
--   - Mapear 'notes' a 'customer_notes' (que es la columna real en orders).
-- =====================================================
...
BEGIN
  ...
  -- 7. Insertar pedido con las columnas corregidas de la tabla orders
